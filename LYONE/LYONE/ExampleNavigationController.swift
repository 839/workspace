...
class ExampleNavigationController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        #if swift(>=4.0)
            self.navigationBar.titleTextAttributes = [NSAttributedStringKey.foregroundColor : UIColor.init(red:  CGFloat(drand48()), green:  CGFloat(drand48()), blue:  CGFloat(drand48()), alpha: 1.0), NSAttributedStringKey.font: UIFont.systemFont(ofSize: 16.0)]
        #elseif swift(>=3.0)
        ...
        #endif
        self.navigationBar.tintColor = UIColor.init(red: CGFloat(drand48()), green:  CGFloat(drand48()), blue:  CGFloat(drand48()), alpha: 1.0)
        print("----rand: \(drand48())")
